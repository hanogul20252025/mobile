...
class AuthService implements AuthServiceInterface{
  ...
  Future<void> _updateHeaderFunctionality(AuthResponseModel authResponse, {bool alreadyInApp = false}) async {
    if (authResponse.isEmailVerified == true && authResponse.isPhoneVerified == true && authResponse.isPersonalInfo == true && authResponse.token != null && authResponse.isExistUser == null){
  ...
  Future<void> socialLogout() async {
    ...
    if (await FacebookAuth.instance.isLogged) {
