            ...
            child: RefreshIndicator(
              ...
              child: ResponsiveHelper.isDesktop(context) ? WebHomeScreen(
                ...
                slivers: [
                  ...
                  /// App Bar
                  SliverAppBar(
                    pinned: true, toolbarHeight: 10, expandedHeight: ResponsiveHelper.isTab(context) ? 60 : GetPlatform.isWeb ? 72 : 50,
                            ...
                            return Center(child: Container(
                              ...
                              child: Opacity(
                                ...
                                child: Row(children: [
                                  ...
                                  Expanded(child: SingleChildScrollView(child: Transform.translate(
